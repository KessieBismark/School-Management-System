...
Public Class allstudent_Report
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MySkul.allstudent_Report.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedallstudent_Report
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As allstudent_Report = New allstudent_Report()
        rpt.Site = Me.Site
        Return rpt
    End Function
